export const injectUi = (window, elementSelectors) => {
  ...
  return {
    ...
    uiElements: {
      ...
      get bookmarkButtons() {
        return window.document.querySelectorAll(elementSelectors.ui.bookmarkButton)
      },
      get modelResponses() {
        return window.document.querySelectorAll(elementSelectors.modelResponse.container);
      }
    }
  };
};
